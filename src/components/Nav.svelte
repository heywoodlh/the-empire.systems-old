...
<style>
    ...
    li:hover {
        box-shadow: inset 0 -0.75em 0 -10px red;
    }
    :global(.nav-item a) {
...
<nav class="navbar">
    <h1 class="site-title">The Empire</h1><span class="site-subtitle">Cybersecurity and Systems Administration</span>
    <ul>
        ...
        <li class="nav-item"><Link to="/contact" name="Contact" /></li>
    </ul>
</nav>
